...
type Status struct {
	...
	SystemBoardRevision *string `json:"systemBoardRevision,omitempty"`
...
// GetSystemBoardRevision returns the SystemBoardRevision field value if set, zero value otherwise.
func (o *Status) GetSystemBoardRevision() string {
	if o == nil || o.SystemBoardRevision == nil {
		var ret string
		return ret
	}
	return *o.SystemBoardRevision
}

// GetSystemBoardRevisionOk returns a tuple with the SystemBoardRevision field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Status) GetSystemBoardRevisionOk() (*string, bool) {
	if o == nil || o.SystemBoardRevision == nil {
		return nil, false
	}
	return o.SystemBoardRevision, true
}
...
// SetSystemBoardRevision gets a reference to the given string and assigns it to the SystemBoardRevision field.
func (o *Status) SetSystemBoardRevision(v string) {
	tmp := v
	o.SystemBoardRevision = &tmp
}
...
// SetResetTime gets a reference to the given int32 and assigns it to the ResetTime field.
...
func (o Status) MarshalJSON() ([]byte, error) {
	...
	if o.SystemBoardRevision != nil {
		toSerialize["systemBoardRevision"] = o.SystemBoardRevision
	}
...
func (o *Status) ApplyMinMaxConstraints() bool {
	...
	if o.HasSystemBoardRevision() {
		var fieldChanged = false
		var v string = o.GetSystemBoardRevision()
		if fieldChanged {
			o.SetSystemBoardRevision(v)
			valueChanged = true
		}
	}
