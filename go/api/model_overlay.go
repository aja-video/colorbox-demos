...
type Overlay struct {
	...
	UserOverlayEnabled *bool `json:"userOverlayEnabled,omitempty"`
...
func NewOverlay() *Overlay {
	...
	var userOverlayEnabled bool = false
	this.UserOverlayEnabled = &userOverlayEnabled
	var libraryEntry int32 = 1
...
// GetUserOverlayEnabled returns the UserOverlayEnabled field value if set, zero value otherwise.
func (o *Overlay) GetUserOverlayEnabled() bool {
	if o == nil || o.UserOverlayEnabled == nil {
		var ret bool
		return ret
	}
	return *o.UserOverlayEnabled
}

// GetUserOverlayEnabledOk returns a tuple with the UserOverlayEnabled field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Overlay) GetUserOverlayEnabledOk() (*bool, bool) {
	if o == nil || o.UserOverlayEnabled == nil {
		return nil, false
	}
	return o.UserOverlayEnabled, true
}
...
// SetUserOverlayEnabled gets a reference to the given bool and assigns it to the UserOverlayEnabled field.
func (o *Overlay) SetUserOverlayEnabled(v bool) {
	tmp := v
	o.UserOverlayEnabled = &tmp
}
...
func (o Overlay) MarshalJSON() ([]byte, error) {
	...
	if o.UserOverlayEnabled != nil {
		toSerialize["userOverlayEnabled"] = o.UserOverlayEnabled
	}
