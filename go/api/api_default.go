...
type ApiGetAcesConfigRequest struct {
	ctx context.Context
	ApiService *DefaultApiService
}


func (r ApiGetAcesConfigRequest) Execute() (*AcesConfig, *http.Response, error) {
	return r.ApiService.GetAcesConfigExecute(r)
}

/*
GetAcesConfig Method for GetAcesConfig

Get the AcesConfig object

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetAcesConfigRequest
*/
func (a *DefaultApiService) GetAcesConfig(ctx context.Context) ApiGetAcesConfigRequest {
	return ApiGetAcesConfigRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return AcesConfig
func (a *DefaultApiService) GetAcesConfigExecute(r ApiGetAcesConfigRequest) (*AcesConfig, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *AcesConfig
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultApiService.GetAcesConfig")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/acesConfig"
...
type ApiGetAmfLibraryRequest struct {
	ctx context.Context
	ApiService *DefaultApiService
}


func (r ApiGetAmfLibraryRequest) Execute() ([]LibraryEntry, *http.Response, error) {
	return r.ApiService.GetAmfLibraryExecute(r)
}

/*
GetAmfLibrary Method for GetAmfLibrary

Get the AMF Library array

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetAmfLibraryRequest
*/
func (a *DefaultApiService) GetAmfLibrary(ctx context.Context) ApiGetAmfLibraryRequest {
	return ApiGetAmfLibraryRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return []LibraryEntry
func (a *DefaultApiService) GetAmfLibraryExecute(r ApiGetAmfLibraryRequest) ([]LibraryEntry, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultApiService.GetAmfLibrary")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/amfLibrary"
...
type ApiGetBuildInfoRequest struct {
	ctx context.Context
	ApiService *DefaultApiService
}


func (r ApiGetBuildInfoRequest) Execute() (*BuildInfo, *http.Response, error) {
	return r.ApiService.GetBuildInfoExecute(r)
}

/*
GetBuildInfo Method for GetBuildInfo

Return the build info object

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetBuildInfoRequest
*/
func (a *DefaultApiService) GetBuildInfo(ctx context.Context) ApiGetBuildInfoRequest {
	return ApiGetBuildInfoRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return BuildInfo
func (a *DefaultApiService) GetBuildInfoExecute(r ApiGetBuildInfoRequest) (*BuildInfo, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *BuildInfo
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultApiService.GetBuildInfo")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/buildInfo"
...
type ApiGetCalibrationPatternRequest struct {
	ctx context.Context
	ApiService *DefaultApiService
}


func (r ApiGetCalibrationPatternRequest) Execute() (*CalibrationPattern, *http.Response, error) {
	return r.ApiService.GetCalibrationPatternExecute(r)
}

/*
GetCalibrationPattern Method for GetCalibrationPattern

Return the calibration pattern object

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetCalibrationPatternRequest
*/
func (a *DefaultApiService) GetCalibrationPattern(ctx context.Context) ApiGetCalibrationPatternRequest {
	return ApiGetCalibrationPatternRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *DefaultApiService) GetCalibrationPatternExecute(r ApiGetCalibrationPatternRequest) (*CalibrationPattern, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *CalibrationPattern
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultApiService.GetCalibrationPattern")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/calibrationPattern"
...
type ApiGetOrionPresetLibraryRequest struct {
	ctx context.Context
	ApiService *DefaultApiService
}


func (r ApiGetOrionPresetLibraryRequest) Execute() ([]LibraryEntry, *http.Response, error) {
	return r.ApiService.GetOrionPresetLibraryExecute(r)
}

/*
GetOrionPresetLibrary Method for GetOrionPresetLibrary

Get the Orion Preset Library array

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetOrionPresetLibraryRequest
*/
func (a *DefaultApiService) GetOrionPresetLibrary(ctx context.Context) ApiGetOrionPresetLibraryRequest {
	return ApiGetOrionPresetLibraryRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return []LibraryEntry
func (a *DefaultApiService) GetOrionPresetLibraryExecute(r ApiGetOrionPresetLibraryRequest) ([]LibraryEntry, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultApiService.GetOrionPresetLibrary")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/orionPresetLibrary"
...
type ApiGetOverlayLibraryRequest struct {
	ctx context.Context
	ApiService *DefaultApiService
}


func (r ApiGetOverlayLibraryRequest) Execute() ([]LibraryEntry, *http.Response, error) {
	return r.ApiService.GetOverlayLibraryExecute(r)
}

/*
GetOverlayLibrary Method for GetOverlayLibrary

Get the overlay Library array

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetOverlayLibraryRequest
*/
func (a *DefaultApiService) GetOverlayLibrary(ctx context.Context) ApiGetOverlayLibraryRequest {
	return ApiGetOverlayLibraryRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return []LibraryEntry
func (a *DefaultApiService) GetOverlayLibraryExecute(r ApiGetOverlayLibraryRequest) ([]LibraryEntry, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultApiService.GetOverlayLibrary")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/overlayLibrary"
...
type ApiSaveDynamicLutRequestRequest struct {
	ctx context.Context
	ApiService *DefaultApiService
}


func (r ApiSaveDynamicLutRequestRequest) Execute() (*http.Response, error) {
	return r.ApiService.SaveDynamicLutRequestExecute(r)
}
...
*/
func (a *DefaultApiService) SaveDynamicLutRequest(ctx context.Context) ApiSaveDynamicLutRequestRequest {
	return ApiSaveDynamicLutRequestRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
func (a *DefaultApiService) SaveDynamicLutRequestExecute(r ApiSaveDynamicLutRequestRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultApiService.SaveDynamicLutRequest")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/saveDynamicLutRequest"
...
type ApiSetAcesConfigRequest struct {
	ctx context.Context
	ApiService *DefaultApiService
...
// AcesConfig object
func (r ApiSetAcesConfigRequest) AcesConfig(acesConfig AcesConfig) ApiSetAcesConfigRequest {
	r.acesConfig = &acesConfig
	return r
}

func (r ApiSetAcesConfigRequest) Execute() (*http.Response, error) {
	return r.ApiService.SetAcesConfigExecute(r)
}

/*
SetAcesConfig Method for SetAcesConfig

Modify the AcesConfig object

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiSetAcesConfigRequest
*/
func (a *DefaultApiService) SetAcesConfig(ctx context.Context) ApiSetAcesConfigRequest {
	return ApiSetAcesConfigRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
func (a *DefaultApiService) SetAcesConfigExecute(r ApiSetAcesConfigRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultApiService.SetAcesConfig")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
	...
	localVarFormParams := url.Values{}
	if r.acesConfig == nil {
		return nil, reportError("acesConfig is required and must be specified")
	}
...
type ApiSetCalibrationPatternRequest struct {
	ctx context.Context
	ApiService *DefaultApiService
	calibrationPattern *CalibrationPattern
}

// CalibrationPattern object
func (r ApiSetCalibrationPatternRequest) CalibrationPattern(calibrationPattern CalibrationPattern) ApiSetCalibrationPatternRequest {
	r.calibrationPattern = &calibrationPattern
	return r
}

func (r ApiSetCalibrationPatternRequest) Execute() (*http.Response, error) {
	return r.ApiService.SetCalibrationPatternExecute(r)
}

/*
SetCalibrationPattern Method for SetCalibrationPattern

Modify the calibration pattern object

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiSetCalibrationPatternRequest
*/
func (a *DefaultApiService) SetCalibrationPattern(ctx context.Context) ApiSetCalibrationPatternRequest {
	return ApiSetCalibrationPatternRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
func (a *DefaultApiService) SetCalibrationPatternExecute(r ApiSetCalibrationPatternRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultApiService.SetCalibrationPattern")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.calibrationPattern == nil {
		return nil, reportError("calibrationPattern is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.calibrationPattern
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return nil, err
	}
...
// The kind of file being uploaded valid kinds are: **lut_1d**, **lut_3d**, **matrix**, **image**, **overlay**, **preset**, **orionPreset**, **license**, **update**
...
func (r ApiUploadFileRequest) Execute() (string, *http.Response, error) {
...
// Execute executes the request
//  @return string
func (a *DefaultApiService) UploadFileExecute(r ApiUploadFileRequest) (string, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
...
type ApiUploadMultipleFilesRequest struct {
	ctx context.Context
	ApiService *DefaultApiService
	file *[]*os.File
	kind *string
...
func (r ApiUploadMultipleFilesRequest) File(file []*os.File) ApiUploadMultipleFilesRequest {
	r.file = &file
	return r
}
// The kind of file being uploaded valid kinds are: **amf**
func (r ApiUploadMultipleFilesRequest) Kind(kind string) ApiUploadMultipleFilesRequest {
	r.kind = &kind
	return r
}
// The entry number to upload the file to
func (r ApiUploadMultipleFilesRequest) Entry(entry int32) ApiUploadMultipleFilesRequest {
	r.entry = &entry
	return r
}
// The AMF file that should be used from the sent files, an uploaded directory can contain multiple AMF files, the one that matches this parameter will be the one stored to the device.
func (r ApiUploadMultipleFilesRequest) Selection(selection string) ApiUploadMultipleFilesRequest {
	r.selection = &selection
	return r
}

func (r ApiUploadMultipleFilesRequest) Execute() (string, *http.Response, error) {
	return r.ApiService.UploadMultipleFilesExecute(r)
}

/*
UploadMultipleFiles Method for UploadMultipleFiles

Upload Multiple files

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiUploadMultipleFilesRequest
*/
func (a *DefaultApiService) UploadMultipleFiles(ctx context.Context) ApiUploadMultipleFilesRequest {
	return ApiUploadMultipleFilesRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return string
func (a *DefaultApiService) UploadMultipleFilesExecute(r ApiUploadMultipleFilesRequest) (string, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultApiService.UploadMultipleFiles")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/uploadMultiple"
	...
	if r.selection != nil {
		localVarFormParams.Add("selection", parameterToString(*r.selection, ""))
	}
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
