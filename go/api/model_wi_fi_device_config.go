...
type WiFiDeviceConfig struct {
	...
	WifiPasswordLength *int32 `json:"wifiPasswordLength,omitempty"`
	WifiRegion *string `json:"wifiRegion,omitempty"`
}
...
// GetWifiPasswordLength returns the WifiPasswordLength field value if set, zero value otherwise.
func (o *WiFiDeviceConfig) GetWifiPasswordLength() int32 {
	if o == nil || o.WifiPasswordLength == nil {
		var ret int32
		return ret
	}
	return *o.WifiPasswordLength
}

// GetWifiPasswordLengthOk returns a tuple with the WifiPasswordLength field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *WiFiDeviceConfig) GetWifiPasswordLengthOk() (*int32, bool) {
	if o == nil || o.WifiPasswordLength == nil {
		return nil, false
	}
	return o.WifiPasswordLength, true
}
...
// SetWifiPasswordLength gets a reference to the given int32 and assigns it to the WifiPasswordLength field.
func (o *WiFiDeviceConfig) SetWifiPasswordLength(v int32) {
	tmp := v
	o.WifiPasswordLength = &tmp
}

// GetWifiRegion returns the WifiRegion field value if set, zero value otherwise.
func (o *WiFiDeviceConfig) GetWifiRegion() string {
	if o == nil || o.WifiRegion == nil {
		var ret string
		return ret
	}
	return *o.WifiRegion
...
// GetWifiRegionOk returns a tuple with the WifiRegion field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *WiFiDeviceConfig) GetWifiRegionOk() (*string, bool) {
	if o == nil || o.WifiRegion == nil {
		return nil, false
	}
	return o.WifiRegion, true
}
...
// SetWifiRegion gets a reference to the given string and assigns it to the WifiRegion field.
...
func (o WiFiDeviceConfig) MarshalJSON() ([]byte, error) {
	...
	if o.WifiPasswordLength != nil {
		toSerialize["wifiPasswordLength"] = o.WifiPasswordLength
	}
	if o.WifiRegion != nil {
		toSerialize["wifiRegion"] = o.WifiRegion
	}
...
func (o *WiFiDeviceConfig) ApplyMinMaxConstraints() bool {
	...
	if o.HasWifiPasswordLength() {
		var fieldChanged = false
		var v int32 = o.GetWifiPasswordLength()
		if fieldChanged {
			o.SetWifiPasswordLength(v)
			valueChanged = true
		}
	}
	if o.HasWifiRegion() {
		var fieldChanged = false
		var v string = o.GetWifiRegion()
		if fieldChanged {
			o.SetWifiRegion(v)
			valueChanged = true
		}
