...
function(add_api_subdirectory target)
	...
	if (EXISTS ${target_path} AND EXISTS ${target_path}/CMakeLists.txt)
		...
		set(status_msg "ColorBox cpp-restsdk: added target: ${target}")
...
function(add_demo_subdirectory target)
	...
	if (EXISTS ${target_path} AND EXISTS ${target_path}/CMakeLists.txt)
		add_subdirectory(${target_path})
		set(status_msg "ColorBox cpp-restsdk Demo: added target: ${target}")
		message(STATUS ${status_msg})
	endif()
endfunction()
...
function(add_sdk_subdirectory target_dir)
	set(target "")
	if(${target_dir} STREQUAL "ntv2sdk")
		set(target "ajantv2")
	endif()
