...
bool BbcConfig::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void BbcConfig::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool BbcConfig::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::shared_ptr<Stage> BbcConfig::getLut1d1() const
{
    return m_Lut1d_1;
}
...
bool BbcConfig::lut1d1IsSet() const
{
    return m_Lut1d_1IsSet;
}

void BbcConfig::unsetLut1d_1()
{
    m_Lut1d_1IsSet = false;
}
...
bool BbcConfig::m3x32IsSet() const
{
    return m_M3x3_2IsSet;
}

void BbcConfig::unsetM3x3_2()
{
    m_M3x3_2IsSet = false;
}
...
bool BbcConfig::lut3d1IsSet() const
{
    return m_Lut3d_1IsSet;
}

void BbcConfig::unsetLut3d_1()
{
    m_Lut3d_1IsSet = false;
}
