...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_Preview_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_Preview_H_
...
public:
    ...
    /// </summary>
    utility::string_t getImageType() const;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_Preview_H_ */
