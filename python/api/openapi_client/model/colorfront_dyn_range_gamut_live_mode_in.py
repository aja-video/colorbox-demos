...
class ColorfrontDynRangeGamutLiveModeIn(ModelSimple):
    ...
    allowed_values = {
        ('value',): {
            ...
            'SONY_SLOG3_S-GAMUT3_CINE': "Sony SLog3 S-Gamut3 Cine",
    ...
    def __init__(self, *args, **kwargs):
        """ColorfrontDynRangeGamutLiveModeIn - a model defined in OpenAPI
