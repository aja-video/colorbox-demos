...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.get1d_lut_library  # this is an instance of the class Endpoint
        api_instance.get1d_lut_library()  # this invokes api_instance.get1d_lut_library.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get1d_lut_library.callable or self.callable in this class
