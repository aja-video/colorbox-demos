...
#ifndef OAINbcConfig_H
#define OAINbcConfig_H
...
class OAINbcConfig : public OAIObject {
public:
    OAINbcConfig();
    OAINbcConfig(QString json);
    ~OAINbcConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINbcConfig)

#endif // OAINbcConfig_H
