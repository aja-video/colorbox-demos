...
void OAIWiFiDeviceConfig::initializeModel() {
    ...
    m_wifi_password_length_isSet = false;
    m_wifi_password_length_isValid = false;

    m_wifi_region_isSet = false;
    m_wifi_region_isValid = false;
}
...
void OAIWiFiDeviceConfig::fromJsonObject(QJsonObject json) {
    ...
    m_wifi_password_length_isValid = ::OpenAPI::fromJsonValue(m_wifi_password_length, json[QString("wifiPasswordLength")]);
    m_wifi_password_length_isSet = !json[QString("wifiPasswordLength")].isNull() && m_wifi_password_length_isValid;

    m_wifi_region_isValid = ::OpenAPI::fromJsonValue(m_wifi_region, json[QString("wifiRegion")]);
    m_wifi_region_isSet = !json[QString("wifiRegion")].isNull() && m_wifi_region_isValid;
...
QJsonObject OAIWiFiDeviceConfig::asJsonObject() const {
    ...
    if (m_wifi_password_length_isSet) {
        obj.insert(QString("wifiPasswordLength"), ::OpenAPI::toJsonValue(m_wifi_password_length));
    }
    if (m_wifi_region_isSet) {
        obj.insert(QString("wifiRegion"), ::OpenAPI::toJsonValue(m_wifi_region));
    }
    return obj;
}
...
qint32 OAIWiFiDeviceConfig::getWifiPasswordLength() const {
    return m_wifi_password_length;
}
void OAIWiFiDeviceConfig::setWifiPasswordLength(const qint32 &wifi_password_length) {
	qint32 v = wifi_password_length;
	this->m_wifi_password_length = v;
    this->m_wifi_password_length_isSet = true;
}

bool OAIWiFiDeviceConfig::is_wifi_password_length_Set() const{
    return m_wifi_password_length_isSet;
}

bool OAIWiFiDeviceConfig::is_wifi_password_length_Valid() const{
    return m_wifi_password_length_isValid;
}



QString OAIWiFiDeviceConfig::getWifiRegion() const {
    return m_wifi_region;
}
void OAIWiFiDeviceConfig::setWifiRegion(const QString &wifi_region) {
	QString v = wifi_region;
	this->m_wifi_region = v;
    this->m_wifi_region_isSet = true;
}

bool OAIWiFiDeviceConfig::is_wifi_region_Set() const{
    return m_wifi_region_isSet;
}

bool OAIWiFiDeviceConfig::is_wifi_region_Valid() const{
    return m_wifi_region_isValid;
}
