...
public:
    ...
    void setUserOverlayEnabled(const bool &user_overlay_enabled);
    bool is_user_overlay_enabled_Set() const;
    bool is_user_overlay_enabled_Valid() const;
...
private:
    ...
    bool m_user_overlay_enabled;
    bool m_user_overlay_enabled_isSet;
    bool m_user_overlay_enabled_isValid;
