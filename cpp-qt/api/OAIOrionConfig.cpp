...
void OAIOrionConfig::initializeModel() {
    ...
    m_gamma_comp_isSet = false;
    m_gamma_comp_isValid = false;
...
void OAIOrionConfig::fromJsonObject(QJsonObject json) {
    ...
    m_gamma_comp_isValid = ::OpenAPI::fromJsonValue(m_gamma_comp, json[QString("gammaComp")]);
    m_gamma_comp_isSet = !json[QString("gammaComp")].isNull() && m_gamma_comp_isValid;
...
QJsonObject OAIOrionConfig::asJsonObject() const {
    ...
    if (m_gamma_comp_isSet) {
        obj.insert(QString("gammaComp"), ::OpenAPI::toJsonValue(m_gamma_comp));
    }
...
bool OAIOrionConfig::isGammaComp() const {
    return m_gamma_comp;
}
void OAIOrionConfig::setGammaComp(const bool &gamma_comp) {
	bool v = gamma_comp;
	this->m_gamma_comp = v;
    this->m_gamma_comp_isSet = true;
}

bool OAIOrionConfig::is_gamma_comp_Set() const{
    return m_gamma_comp_isSet;
}

bool OAIOrionConfig::is_gamma_comp_Valid() const{
    return m_gamma_comp_isValid;
}
