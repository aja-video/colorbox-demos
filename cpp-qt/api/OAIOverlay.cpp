...
void OAIOverlay::initializeModel() {
    ...
    m_user_overlay_enabled_isSet = false;
    m_user_overlay_enabled_isValid = false;
...
void OAIOverlay::fromJsonObject(QJsonObject json) {
    ...
    m_user_overlay_enabled_isValid = ::OpenAPI::fromJsonValue(m_user_overlay_enabled, json[QString("userOverlayEnabled")]);
    m_user_overlay_enabled_isSet = !json[QString("userOverlayEnabled")].isNull() && m_user_overlay_enabled_isValid;
...
QJsonObject OAIOverlay::asJsonObject() const {
    ...
    if (m_user_overlay_enabled_isSet) {
        obj.insert(QString("userOverlayEnabled"), ::OpenAPI::toJsonValue(m_user_overlay_enabled));
    }
...
bool OAIOverlay::isUserOverlayEnabled() const {
    return m_user_overlay_enabled;
}
void OAIOverlay::setUserOverlayEnabled(const bool &user_overlay_enabled) {
	bool v = user_overlay_enabled;
	this->m_user_overlay_enabled = v;
    this->m_user_overlay_enabled_isSet = true;
}

bool OAIOverlay::is_user_overlay_enabled_Set() const{
    return m_user_overlay_enabled_isSet;
}

bool OAIOverlay::is_user_overlay_enabled_Valid() const{
    return m_user_overlay_enabled_isValid;
}


qint32 OAIOverlay::getLibraryEntry() const {
    return m_library_entry;
}
void OAIOverlay::setLibraryEntry(const qint32 &library_entry) {
	qint32 v = library_entry;
	this->m_library_entry = v;
    this->m_library_entry_isSet = true;
}

bool OAIOverlay::is_library_entry_Set() const{
    return m_library_entry_isSet;
}

bool OAIOverlay::is_library_entry_Valid() const{
