...
void OAIStatus::initializeModel() {
    ...
    m_system_board_revision_isSet = false;
    m_system_board_revision_isValid = false;
    ...
    m_reset_time_isSet = false;
    m_reset_time_isValid = false;
...
void OAIStatus::fromJsonObject(QJsonObject json) {
    ...
    m_system_board_revision_isValid = ::OpenAPI::fromJsonValue(m_system_board_revision, json[QString("systemBoardRevision")]);
    m_system_board_revision_isSet = !json[QString("systemBoardRevision")].isNull() && m_system_board_revision_isValid;
    ...
    m_reset_time_isValid = ::OpenAPI::fromJsonValue(m_reset_time, json[QString("resetTime")]);
    m_reset_time_isSet = !json[QString("resetTime")].isNull() && m_reset_time_isValid;
...
QJsonObject OAIStatus::asJsonObject() const {
    ...
    if (m_system_board_revision_isSet) {
        obj.insert(QString("systemBoardRevision"), ::OpenAPI::toJsonValue(m_system_board_revision));
    }
    ...
    if (m_reset_time_isSet) {
        obj.insert(QString("resetTime"), ::OpenAPI::toJsonValue(m_reset_time));
    }
...
QString OAIStatus::getSystemBoardRevision() const {
    return m_system_board_revision;
}
void OAIStatus::setSystemBoardRevision(const QString &system_board_revision) {
	QString v = system_board_revision;
	this->m_system_board_revision = v;
    this->m_system_board_revision_isSet = true;
}

bool OAIStatus::is_system_board_revision_Set() const{
    return m_system_board_revision_isSet;
}

bool OAIStatus::is_system_board_revision_Valid() const{
    return m_system_board_revision_isValid;
}
...
qint32 OAIStatus::getResetTime() const {
    return m_reset_time;
}
void OAIStatus::setResetTime(const qint32 &reset_time) {
	qint32 v = reset_time;
	this->m_reset_time = v;
    this->m_reset_time_isSet = true;
}

bool OAIStatus::is_reset_time_Set() const{
    return m_reset_time_isSet;
}

bool OAIStatus::is_reset_time_Valid() const{
    return m_reset_time_isValid;
}
...
bool OAIStatus::applyMinMaxConstraints() {
	...
	if (is_system_board_revision_Set())
	{
		bool systemBoardRevisionChanged = false;
		QString v = getSystemBoardRevision();
	...
	if (is_reset_time_Set())
	{
		bool resetTimeChanged = false;
		qint32 v = getResetTime();
