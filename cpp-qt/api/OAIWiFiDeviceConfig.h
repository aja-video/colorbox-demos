...
public:
    ...
    qint32 getWifiPasswordLength() const;
    void setWifiPasswordLength(const qint32 &wifi_password_length);
    bool is_wifi_password_length_Set() const;
    bool is_wifi_password_length_Valid() const;

    QString getWifiRegion() const;
    void setWifiRegion(const QString &wifi_region);
    bool is_wifi_region_Set() const;
    bool is_wifi_region_Valid() const;
...
private:
    ...
    qint32 m_wifi_password_length;
    bool m_wifi_password_length_isSet;
    bool m_wifi_password_length_isValid;

    QString m_wifi_region;
    bool m_wifi_region_isSet;
    bool m_wifi_region_isValid;
};
